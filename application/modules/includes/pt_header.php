<body class="skin-josh">
    <header class="header">
        <a href="index.html" class="logo">
            <img src="<?php base_url() ?>assets/images/logo.png" alt="Logo" width="50px">
        </a>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header bg-light-blue">
                                ...
                                <p class="topprofiletext"><?php echo $this->session->userdata['logged_in']['email'] ?></p>
                            </li>
                  ...
                  <!--  <div class="nav_icons">
                    ...
                    <ul id="menu" class="page-sidebar-menu">
                        ...
                        <!--<li>
                            <a href="#">
                                <i class="livicon" data-name="table" data-c="#418BCA" data-hc="#418BCA" data-size="18" data-loop="true"></i>
                                <span class="title">Class Teacher</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                       ...
                       <!-- <li>
                        ...
                        <li>
                            <a href="#">
                                <i class="livicon" data-name="table" data-c="#418BCA" data-hc="#418BCA" data-size="18" data-loop="true"></i>
                                <span class="title">PT Teacher</span>
                                <!--<span class="fa arrow"></span>
                            </a>
                            <!--<ul class="sub-menu">
                                <li>
